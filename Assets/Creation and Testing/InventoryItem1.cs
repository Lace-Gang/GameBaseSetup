...
namespace GameBase
{
    public abstract class InventoryItem1 : ItemBase //SavableItem, IDataPersistence
    {
        //Hidden Variables
        ...
        [Tooltip("Can thibe equipped from inventory")]
        ...
        public static bool operator ==(InventoryItem1 a, InventoryItem1 b)
        {
